      ...
      <div class="quick-actions-grid">
        <div class="section-card">
          ...
          <div class="actions-grid">
            <button class="action-card" (click)="navigateTo('/manager/tasks')">
            ...
            <button class="action-card" (click)="navigateTo('/manager/students')">
            ...
            <button class="action-card" (click)="navigateTo('/manager/leads')">
            ...
            <button class="action-card" (click)="navigateTo('/manager/employees')">
        ...
        <div class="section-card">
          ...
          <div class="actions-grid">
            <button class="action-card" (click)="navigateTo('/manager/hierarchy')">
            ...
            <button class="action-card" (click)="navigateTo('/manager/referrals')">
            ...
            <button class="action-card" (click)="navigateTo('/manager/payments')">
            ...
            <button class="action-card" (click)="navigateTo('/manager/documents')">
